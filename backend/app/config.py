...
ADMIN_SESSION_COOKIE_NAME = os.getenv("SAVEPLAN_ADMIN_SESSION_COOKIE_NAME", "saveplan_admin_session")
ADMIN_SESSION_COOKIE_SECURE = os.getenv("SAVEPLAN_ADMIN_SESSION_COOKIE_SECURE", "false").lower() == "true"
ADMIN_SESSION_COOKIE_SAMESITE = os.getenv("SAVEPLAN_ADMIN_SESSION_COOKIE_SAMESITE", "lax")
ADMIN_SESSION_COOKIE_DOMAIN = os.getenv("SAVEPLAN_ADMIN_SESSION_COOKIE_DOMAIN") or None
...
INITIAL_USER_POINTS = int(os.getenv("SAVEPLAN_INITIAL_USER_POINTS", "100"))
CONVERSION_POINT_COST = int(os.getenv("SAVEPLAN_CONVERSION_POINT_COST", "1"))
ZPAY_PAYMENT_URL_TEMPLATE = os.getenv("ZPAY_PAYMENT_URL_TEMPLATE", "").strip()
