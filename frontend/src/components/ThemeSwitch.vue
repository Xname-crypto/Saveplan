...
<template>
  <label class="theme-switch" :aria-label="ariaLabel" :title="ariaLabel">
    <input
      ...
      <span class="theme-switch__circle-container">
        <span class="theme-switch__sun-moon-container">
          <span class="theme-switch__moon">
            <span class="theme-switch__spot" />
            <span class="theme-switch__spot" />
            <span class="theme-switch__spot" />
          </span>
        </span>
      </span>
      <span class="theme-switch__shooting-star" />
      <span class="theme-switch__shooting-star-2" />
      <span class="theme-switch__meteor" />
      <span class="theme-switch__stars-cluster">
        <span v-for="index in 5" :key="index" class="star" />
      </span>
      <span class="theme-switch__aurora" />
      <span class="theme-switch__comets">
        <span class="comet" />
        <span class="comet" />
      </span>
    </span>
...
.theme-switch__container:hover .theme-switch__sun-moon-container {
...
.theme-switch__stars-cluster .star:nth-child(1) {
  top: 20%;
  left: 20%;
  animation: themeTwinkle 1s infinite ease-in-out;
}

.theme-switch__stars-cluster .star:nth-child(2) {
  top: 30%;
  left: 55%;
  animation: themeTwinkle 1s infinite ease-in-out 0.3s;
}

.theme-switch__stars-cluster .star:nth-child(3) {
  top: 40%;
  left: 80%;
  animation: themeTwinkle 1s infinite ease-in-out 0.6s;
}

.theme-switch__stars-cluster .star:nth-child(4) {
  top: 60%;
  left: 30%;
  animation: themeTwinkle 1s infinite ease-in-out 0.9s;
}

.theme-switch__stars-cluster .star:nth-child(5) {
  top: 70%;
  left: 65%;
  animation: themeTwinkle 1s infinite ease-in-out 1.2s;
}
...
.theme-switch__checkbox:checked + .theme-switch__container .theme-switch__aurora {
  animation: themeAuroraWave 8s linear infinite;
}
